...
AOthr, stim_dur, SFOscDur  = 2, 60., 8.
#AOthr, stim_dur, SFOscDur  = 2, 5., 8.
#AOthr, stim_dur, SFOscDur  = 2, 2,   8.
...
while (k <  numStims ):
    ...
    subpat = int(subpats)
    print 'base level'
    aout.set_voltage(AOthr, baseLevelPat/2) # To book keep the LED pattern presented
    ...
    aout.set_voltage(AOthr, subpats/2)
