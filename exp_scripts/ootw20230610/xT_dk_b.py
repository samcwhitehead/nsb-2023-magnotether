...
AOthr, stim_dur, SFOsc_dur  = 2, 180., 8.
#AOthr, stim_dur, SFOsc_dur  = 2, 8., 8.
...
ctlr.Start()
time.sleep(SFOsc_dur)
ctlr.Stop()
time.sleep(slpT)

# darkness
print 'darkness for 3 min.'
aout.set_voltage(AOthr,allOffPat/2) # For book keeping of the LED pattern presented
ctlr.AllOff()
time.sleep(stim_dur)
